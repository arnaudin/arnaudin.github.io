---
layout: post
title: "What Owning the Roadmap Taught Me About Design"
date: 2025-05-12 10:00:00
categories: blog
author: Ryan Arnaudin
blurb: For a few years I was the PM as well as the designer. Going back to design afterward, I wasn't the same designer.
image: images/black-thumbnail.jpg
priority: 0.6
published: true
---
At Brightidea I gradually stopped being just the designer. Leading Programs, Idea Box, and then [Whiteboard](/projects/brightidea-whiteboard/) from zero to one, I worked directly with the CEO on vision and strategy, then owned the roadmap, the backlog, the release cadence, and the launch. This spanned the whole product-lead job, with design folded inside it.
